  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Popup
        ...
        className={cn(
          "fixed top-1/2 left-1/2 z-50 grid w-full max-w-[calc(100%-2rem)] -translate-x-1/2 -translate-y-1/2 gap-4 rounded-2xl",
          "bg-[#111118] border border-white/10 backdrop-blur-xl",
          "p-6 text-sm text-[#F8FAFC] shadow-[0_0_60px_rgba(0,0,0,0.8)]",
